          ...
          <?php while ($row = $result->fetch_assoc()) : ?>
            <tr>
              ...
              <!-- <td><a href="#"><i class="fa-solid fa-eye"></i></a></td>
                ...
                <td><a class="red-icons" href="functions/ver_ficha.php?id=<?php echo $row['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
